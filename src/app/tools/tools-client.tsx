...
const allTools: Tool[] = [
  ...
  { icon: 'FileImage', title: 'Image Converter', description: 'Convert image files between different formats (e.g., JPG, PNG, WEBP).', category: 'Image', link: '#', style: 'primary' },
  ...
  { icon: 'MoveHorizontal', title: 'Image Resizer', description: 'Resize images to custom dimensions. Perfect for web, social media, or documents.', category: 'Image', link: '#', style: 'outline' },
  { icon: 'Braces', title: 'JSON <> CSV Converter', description: 'Convert JSON files to CSV and vice-versa. Supports nested JSON and file uploads.', category: 'Converter', link: '#', style: 'outline' },
  { icon: 'Key', title: 'JWT Decoder', description: 'Decode and inspect JSON Web Tokens to view header and payload data securely.', category: 'Security', link: '#', style: 'outline' },
  { icon: 'FileText', title: 'Markdown to HTML', description: 'Convert Markdown text into clean HTML with a live preview and copy-to-clipboard functionality.', category: 'Converter', link: '#', style: 'outline' },
  { icon: 'Shield', title: 'Password Generator', description: 'Create strong, secure passwords with custom length and character settings.', category: 'Security', link: '#', style: 'outline' },
  { icon: 'FileArchive', title: 'PDF Suite', description: 'Convert images to PDF or extract pages from a PDF file into images.', category: 'Converter', link: '#', style: 'primary' },
  { icon: 'QrCode', title: 'QR Code Generator', description: 'Generate QR codes from any text or URL. Download a high-quality PNG instantly.', category: 'Utility', link: '#', style: 'outline' },
  ...
  { icon: 'Regex', title: 'Regex Tester', description: 'Test and debug your regular expressions with live matching, groups, and replacements.', category: 'Utility', link: '#', style: 'secondary' },
];
