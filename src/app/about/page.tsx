...
const teamMembers = [
  {
    ...
    bio: "Visionary leader with 15+ years in tech, driving innovation and strategic growth through a focus on first-principles thinking and scalable systems.",
  },
  {
    name: "Samantha Lee",
    role: "Lead Developer",
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member) => (
              <Card
                key={member.name}
                className="text-center p-6 transition-all duration-300 hover:-translate-y-2 bg-black/30 backdrop-blur-lg border border-white/10 hover:border-white/30 rounded-2xl shadow-lg"
              >
