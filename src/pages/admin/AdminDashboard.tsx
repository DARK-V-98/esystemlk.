  ...
  return (
    <div className="container mx-auto py-10 px-4 md:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Link to="/admin/users" className="block hover:scale-105 transition-transform duration-300">
        ...
        <Link to="/admin/messages" className="block hover:scale-105 transition-transform duration-300">
            <Card className="bg-card border border-border rounded-2xl shadow-lg h-full hover:border-primary transition-colors">
              <CardHeader className="flex flex-row items-center justify-between">
         ...
         <Link to="/admin/quotation" className="block hover:scale-105 transition-transform duration-300">
            <Card className="bg-card border border-border rounded-2xl shadow-lg h-full hover:border-primary transition-colors">
              <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Link to="/admin/pricing" className="block hover:scale-105 transition-transform duration-300">
            <Card className="bg-card border border-border rounded-2xl shadow-lg h-full hover:border-primary transition-colors">
              <CardHeader className="flex flex-row items-center justify-between">
